  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main navigation */}
        <nav className="flex items-center justify-between py-3 sm:py-4" aria-label="Main navigation">
          <div className="flex items-center space-x-2 sm:space-x-4">
            {/* Enhanced logo */}
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className={`relative p-2 sm:p-3 bg-gradient-to-br ${themeClasses.primary} rounded-2xl shadow-lg group transition-transform hover:scale-105`} aria-hidden="true">
              ...
              <div className="min-w-0">
                <h1 className={`text-lg sm:text-2xl font-bold bg-gradient-to-r ${themeClasses.primary} bg-clip-text text-transparent leading-tight`}>
                  <span className="hidden sm:inline">Invoice Generator</span>
                  <span className="sm:hidden">Invoice Gen</span>
                </h1>
                <p className="text-xs text-slate-500 font-medium hidden sm:block">Professional • Free • Instant</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-1 sm:space-x-3">
            ...
            <Link href="/crm">
              <Button
                variant="ghost"
                size="sm"
                className="text-slate-600 hover:text-slate-800 hover:bg-slate-100 transition-colors duration-200 px-2 sm:px-3"
            ...
            <Button
              ...
              className="group relative bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200 text-blue-700 hover:from-blue-100 hover:to-indigo-100 hover:border-blue-300 hover:text-blue-800 transition-all duration-300 font-medium shadow-sm hover:shadow-md active:scale-95 px-2 sm:px-3"
            >
              <Eye className="h-4 w-4 mr-1 sm:mr-2 group-hover:scale-110 transition-transform duration-200" />
            ...
            <Button
              ...
              className="group relative bg-gradient-to-r from-violet-50 to-purple-50 border-violet-200 text-violet-700 hover:from-violet-100 hover:to-purple-100 hover:border-violet-300 hover:text-violet-800 transition-all duration-300 font-medium shadow-sm hover:shadow-md active:scale-95 px-2 sm:px-3"
              aria-label="Customize theme and appearance"
            >
              <Settings className="h-4 w-4 mr-1 sm:mr-2 group-hover:rotate-90 transition-transform duration-300" aria-hidden="true" />
